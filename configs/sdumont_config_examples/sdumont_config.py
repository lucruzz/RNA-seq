...
config = Config(
    executors=[
        ...
        HighThroughputExecutor(
            label="sdumont_htex_cpu_long_24w",
            address=address_by_hostname(),
            #address=address_by_interface('ib0'),
            max_workers=24,          # Set number of workers per node
            provider=SlurmProvider(
        ...
        HighThroughputExecutor(
            label="sdumont_htex_cpu_long_1w",
            address=address_by_hostname(),
            #address=address_by_interface('ib0'),
            max_workers=1,          # Set number of workers per node
            provider=SlurmProvider(
        ...
        HighThroughputExecutor(
            label="sdumont_htex_mesca2_240w",
            address=address_by_hostname(),
            #address=address_by_interface('ib0'),
            max_workers=240,          # Set number of workers per node
            provider=SlurmProvider(
                cmd_timeout=120,     # Add extra time for slow scheduler responses
                nodes_per_block=1,
                walltime='48:00:00',
        ...
        HighThroughputExecutor(
            label="sdumont_htex_mesca2_10w",
            address=address_by_hostname(),
            #address=address_by_interface('ib0'),
            max_workers=10,          # Set number of workers per node
            provider=SlurmProvider(
                cmd_timeout=120,     # Add extra time for slow scheduler responses
                nodes_per_block=1,
                walltime='48:00:00',
